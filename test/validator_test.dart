...
void parameterTest(Map<String, dynamic> options) {
  ...
  if (options['valid'] != null) {
    ...
    toTest.forEach((v) {
      ...
      List<Object> listToTest = [v];
      listToTest.addAll(args);
      if (Function.apply(options['validator'], listToTest) != true) {
        throw new Exception(
            'validator.$f($args) failed but should have passed');
      }
    });
  }
  ...
  if (options['invalid'] != null) {
    ...
    toTest.forEach((v) {
      ...
      List<Object> listToTest = [v];
      listToTest.addAll(args);
      if (Function.apply(options['validator'], listToTest) != false) {
        throw new Exception(
            'validator.$f($args) passed but should have failed');
      }
    });
  }
}
